package com.leaves.common.security.utils;
...
public class SecurityUtils {
    ...
    public static String getMemberId() {
        String userId = Convert.toStr(getTokenAttributes().get("memberId"));
        return userId;
    }
    ...
    public static Set<String> getRoles() {
        ...
        if (authentication != null && CollectionUtil.isNotEmpty(authentication.getAuthorities())) {
            Set<String> roles = authentication.getAuthorities()
                    .stream()
                    .map(item -> StrUtil.removePrefix(item.getAuthority(), GlobalConstants.ROLE_PREFIX))
    ...
    public static String getDeptId() {
        String deptId = Convert.toStr(getTokenAttributes().get("deptId"));
        return deptId;
    }
