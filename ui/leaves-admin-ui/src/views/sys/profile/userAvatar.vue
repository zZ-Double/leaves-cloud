      ...
      <el-row>
        <el-col :lg="2" :md="2">
          <el-upload action="#" :http-request="requestUpload" :show-file-list="false" :before-upload="beforeUpload">
            <el-button>
              <template #icon><i-ep-upload /></template>选择
            </el-button>
          </el-upload>
        </el-col>
        <el-col :lg="{ span: 1, offset: 2 }" :md="2">
          <el-button @click="changeScale(1)"><template #icon><i-ep-plus /></template></el-button>
        </el-col>
        <el-col :lg="{ span: 1, offset: 1 }" :md="2">
          <el-button @click="changeScale(-1)"><template #icon><i-ep-minus /></template></el-button>
        </el-col>
        <el-col :lg="{ span: 1, offset: 1 }" :md="2">
          <el-button @click="rotateLeft()"><template #icon><i-ep-refreshLeft /></template></el-button>
        </el-col>
        <el-col :lg="{ span: 1, offset: 1 }" :md="2">
          <el-button @click="rotateRight()"><template #icon><i-ep-refresh-right /></template></el-button>
        </el-col>
