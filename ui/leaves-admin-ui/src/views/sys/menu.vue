<template>
    <div class="app-container">
        ...
        <el-card shadow="never" size="small">
            ...
            <el-table 
                v-loading="loading" :data="menuList" highlight-current-row
            ...
            >
                ...
                <el-table-column fixed="right" align="center" label="操作" width="220">
                    <template #default="scope">
                        ...
                        <el-button 
                            v-hasPerm="['sys:menu:edit']" type="primary" link size="small"
                            @click.stop="handleUpdate(scope.row.id)"
                        >
                            <i-ep-edit />编辑
                        </el-button>
                        <el-button 
                            v-hasPerm="['sys:menu:delete']" type="primary" link size="small"
        ...
        <el-dialog 
            v-model="dialog.visible" :title="dialog.title" destroy-on-close append-to-body width="750px"
            @close="closeDialog">
            <el-form ref="menuFormRef" :model="formData" :rules="rules" label-width="100px">
                <el-form-item label="父级菜单" prop="parentId">
                    <el-tree-select 
                        v-model="formData.parentId" placeholder="选择上级菜单" :data="state.menuOptions" filterable
...
import { menuOptionsList } from '@/api/sys/menu/index'
 ...
 */
 async function loadMenuData() {
  ...
  await menuOptionsList().then(({ data }) => {
